#ifndef	PHOENIXON_W5300_W5300_H
#define	PHOENIXON_W5300_W5300_H
/**
 * \file    w5300.h
...
#include "PhoenixonControls_W5300_iinchip_conf.h"
...
#define RCR0            RCR
//2018.05.27 bgkin comment
//expected a field name DSP 28377D Register
//#define RCR1            (RCR + 1)
 ...
 */
void w5300_setGAR(uint8 * addr);    // set gateway address
 ...
 */
void w5300_setSUBR(uint8 * addr); // set subnet mask address

/**
 * It sets the subnet mask address from global variable
 */
void w5300_applySUBR(); // set subnet mask address to SUBR

/**
 * It sets the subnet mask address "0.0.0.0"
 */
void w5300_clearSUBR(); // set subnet mask address "0.0.0.0"
 ...
 */
void w5300_setSIPR(uint8 * addr); // set local IP address
 ...
 * It sets RTR value
 */
void w5300_setRTR(uint16 timeout); // set retry duration for data transmission, connection, closing ...
 ...
 */
uint8 w5300_sysinit(uint8* tx_size, uint8* rx_size); // setting tx/rx buf size
