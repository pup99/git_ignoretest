...
Uint16 AD7608_Conversion(void)
{
	...
	{
		AD7608_CONVERSION
		if(AD7608_BusyCheck())return(SUCCESS); //SUCCESS Or FAIL
	}
...
{
	E_AD7608_OVER_SAMPLING_SELECT e_OverSampling_Old = (E_AD7608_OVER_SAMPLING_SELECT)0xFFFF;
...
{
	E_AD7608_VOLTAGE_RANGE_SELECT e_Voltage_Old = (E_AD7608_VOLTAGE_RANGE_SELECT)0xFFFF;
